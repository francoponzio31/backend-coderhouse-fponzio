...
router.get("/:cid", loginRequired, async (req, res)=>{
    try {
...
router.put("/:cid", loginRequired, async (req, res)=>{
    try {
        const cartId = req.params.cid
...
router.delete("/:cid", loginRequired, async (req, res)=>{
    try {
        const cartId = req.params.cid
...
router.post("/:cid/product/:pid", loginRequired, async (req, res)=>{
    try {
        const cartId = req.params.cid
...
router.delete("/:cid/product/:pid", loginRequired, async (req, res)=>{
    try {
        const cartId = req.params.cid
        const productId = req.params.pid
...
router.put("/:cid/product/:pid", loginRequired, async (req, res)=>{
    try {
        const cartId = req.params.cid
        const productId = req.params.pid
